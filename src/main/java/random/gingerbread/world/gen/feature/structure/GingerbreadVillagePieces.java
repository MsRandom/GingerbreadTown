...
public class GingerbreadVillagePieces {
    ...
    public static void register(ChunkGenerator<?> p_214838_0_, TemplateManager p_214838_1_, BlockPos p_214838_2_, List<StructurePiece> p_214838_3_, SharedSeedRandom p_214838_4_, NoFeatureConfig p_214838_5_) {
        ...
        JigsawManager.field_214891_a.register(new JigsawPattern(start, empty, Collections.singletonList(new Pair<>(new SingleJigsawPiece("gingerbread_villages/town_centers/town_center", none, JigsawPattern.PlacementBehaviour.RIGID), 1)), JigsawPattern.PlacementBehaviour.RIGID));
